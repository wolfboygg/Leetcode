...
public class Number1Count {
    ...
    public int getNumberOf1Count10(int target) {
        if (target < 0) {
            return -1;
        }
        int count = 0;
    ...
    public int getNumberOf1Count11(int target) {
        if (target < 0) {
            return -1;
        }
        int count = 0;
    ...
    public int getNumberOf1Count12(int target) {
        if (target <= 0) {
            return -1;
        }
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(numIn1Count.getNumberOf1Count12(10));
    }
}

...
public class ReverseLink {
    ...
    public Node reverseLink07(Node head) {
        // 翻转链表 通过头插法的方式
        Node pre = new Node(-1);
        while(head != null) {
            Node next = head.next;
    ...
    public Node reverseLink08(Node head) {
        // 反转链表
        if (head == null) {
            return null;
        }
    ...
    public Node reverseLink11(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverseLink12(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverseLink13(Node head) {
        if (head == null) {
            return null;
        }
        Node temp = new Node(-1);
    ...
    public static void main(String[] args) {
        ...
        Node node = reverseLink.reverseLink13(node01);
        while(node != null) {

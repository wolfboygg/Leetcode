...
public class SearchTreeCommonRoot {
    ...
    public TreeNode findComRoot10(TreeNode root, TreeNode node1, TreeNode node2) {
        // 二叉搜索树中查找公共节点
        if (root == null) {
            return null;
        }
    ...
    public TreeNode findComRoot11(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        while(root != null) {
    ...
    public static void main(String[] args) {
        ...
        TreeNode node = searchTreeCommonRoot.findComRoot11(tree, new TreeNode(2), new TreeNode(8));
        if (node != null) {

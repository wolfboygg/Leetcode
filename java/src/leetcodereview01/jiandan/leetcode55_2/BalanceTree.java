...
//        node04.left = node06;
    ...
    public int isBalanceTree12(TreeNode root) {
        if (root == null) {
            return 0;
        }
        int leftDepth = isBalanceTree12(root.left);
        int rightDepth = isBalanceTree12(root.right);
    ...
    public static void main(String[] args) {
        ...
        balanceTree.isBalanceTree11(tree);

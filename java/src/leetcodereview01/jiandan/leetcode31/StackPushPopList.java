...
public class StackPushPopList {
    ...
    public boolean isPopSequence11(int[] pushList, int[] popList) {
        // 判断是否是一个栈的push pop序列
        Stack<Integer> stack = new Stack<>();
        int popIndex = 0;
        for (int i = 0; i < pushList.length; i++) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stackPushPopList.isPopSequence11(pushList, popList));
        System.out.println(stackPushPopList.isPopSequence11(pushList, popList02));
        System.out.println(stackPushPopList.isPopSequence11(pushList, popList));
    }

...
public class MinKNumber {
    ...
    public List<Integer> findMinKNumberByDump11(int[] arr, int k) {
        // 使用堆进行实现
        PriorityQueue<Integer> queue = new PriorityQueue<>(new Comparator<Integer>() {
            @Override
            public int compare(Integer o1, Integer o2) {
    ...
    // 最小的K个数
    public List<Integer> findMinKNumberByDump12(int[] arr, int k) {
        // 找到最小的K个数 通过堆的形式
        if (arr == null || arr.length == 0) {
            return null;
        }
    ...
    public List<Integer> findMinKNumberByDump14(int[] arr, int k) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        Queue<Integer> queue = new PriorityQueue<>(((o1, o2) -> o1 - o2));
    ...
    public static void main(String[] args) {
        ...
        List<Integer> minKNumByDump = minKNumber.findMinKNumberByDump14(arr, 4);

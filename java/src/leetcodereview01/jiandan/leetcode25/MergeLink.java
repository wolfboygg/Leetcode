...
public class MergeLink {
    ...
    public Node merge10(Node node1, Node node2) {
        if (node1 == null && node2 == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    // merge Link
    public Node merge11(Node node1, Node node2) {
        if (node1 == null && node2 == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node merge12(Node node1, Node node2) {
        // merge 链表
        if (node1 == null && node2 == null) {
            return null;
        }
    ...
    public Node merge13(Node node1, Node node2) {
        Node pre = new Node(-1);
        Node temp = pre;
        while(node1 != null && node2 != null) {
            if (node1.value < node2.value) {
    ...
    public Node merge14(Node node1, Node node2) {
        Node pre = new Node(-1);
        Node temp = pre;
        while(node1 != null && node2 != null) {
            if (node1.value < node2.value) {

...
public class MaxCommonStr {
    ...
    // 公共字串必须连续
    public int findMaxCommonStr09(String s1, String s2) {
        char[] s1Arr = s1.toCharArray();
        char[] s2Arr = s2.toCharArray();
        int[][] matrix = new int[s1Arr.length + 1][s2Arr.length + 1];
        int max = 0;
    ...
    // 最大公共子序列
    public int findMaxCommonSequence09(String s1, String s2) {
        char[] s1Arr = s1.toCharArray();
        char[] s2Arr = s2.toCharArray();
        int max = 0;
        int[][] matrix = new int[s1Arr.length + 1][s2Arr.length + 1];
    ...
    public static void main(String[] args) {
        ...
        int maxLength = maxCommonStr.findMaxCommonStr09(s1, s2);
        System.out.println(maxLength);
        int maxSequence = maxCommonStr.findMaxCommonSequence09(s1, s2);

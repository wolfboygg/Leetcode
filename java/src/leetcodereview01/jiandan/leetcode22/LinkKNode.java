...
public class LinkKNode {
    ...
    public Node getTailKNode12(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node pre = head;
    ...
    public Node getTailKNode13(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node getTailKNode14(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node getTailKNode15(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public static void main(String[] args) {
        ...
        node03.next = node04;
        node04.next = node05;
        Node node = linkKNode.getTailKNode15(node01, 1);

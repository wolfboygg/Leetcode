...
public class SymmetricTree {
    ...
    public boolean isSymmetric01(TreeNode root) {
        ...
        return realSymmetric02(root, root);
    }

    public boolean realSymmetric02(TreeNode left, TreeNode right) {
        if (left == null && right == null) {
            return true;
        }
        if (left == null || right == null) {
        ...
        return left.value == right.value && realSymmetric02(left.left, right.right) && realSymmetric02(left.right, right.left);
    }

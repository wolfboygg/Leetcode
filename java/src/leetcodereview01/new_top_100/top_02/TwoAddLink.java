...
public class TwoAddLink {
    ...
    public ListNode addTwoNumber09(ListNode node1, ListNode node2) {
        if (node1 == null && node2 == null) {
            return null;
        }
        if (node1 == null || node2 == null) {
            ...
            if (node1 == null && node2 == null) {
                ...
                while(carry > 0) {
                    if (node == null) {
                        ...
                        temp.next = node;
                        temp = temp.next;
                        System.out.println("asdfadfasd:" + node.val);
                        node = node.next;
                    }
                }
            }
   ...
   public ListNode addTowNumber11(ListNode node1, ListNode node2) {
        if (node1 == null && node2 == null) {
            return null;
        }
        ListNode temp = new ListNode(-1);
    ...
    public static void main (String[]args){
        ...
        ListNode node = twoAddLink.addTowNumber11(node1, node4);
        while (node != null) {

...
public class MaxProfit {
    ...
    public int getMaxProfit08(int[] arr) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        int min = arr[0];
    ...
    public int getMaxProfit09(int[] arr) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        int max = 0;
    ...
    public int getMaxProfit10(int[] arr) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        int minValue = arr[0];
    ...
    public int getMaxProfit11(int[] arr) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        int minValue = arr[0];

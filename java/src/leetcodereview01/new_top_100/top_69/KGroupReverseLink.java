...
//        System.out.println();
    ...
    public Node kGroupReverse05(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
        ...
        while(P2.next != null) {
            ...
            Node next = P2 == null ? null : P2.next;
            if (P2 != null) {
                P2.next = null;
            }
            P2 = P1.next;
            P1.next = reverse01(P1.next);
            P1 = P2;
            P2.next = next;
        }
        return pre.next;
    ...
    public Node kGroupReverse06(Node head, int k) {
        if (head == null || k == 0) {
            return head;
        }

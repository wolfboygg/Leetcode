...
public class CircleStartNode {
    ...
    public Node findCircleStart06(Node head) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node findCircleStart07(Node head) {
        if (head == null) {
            return null;
        }
        boolean isHasCircle = false;
    ...
    public Node findCircleStart08(Node head) {
        if (head == null) {
            return null;
        }
    ...
    public Node findCircleStart10(Node head) {
        if (head == null) {
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(circleStartNode.findCircleStart10(node1).value);
    }

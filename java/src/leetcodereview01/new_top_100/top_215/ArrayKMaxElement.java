...
public class ArrayKMaxElement {
    ...
    public int getKMaxElement09(int[] arr, int k) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        Queue<Integer> queue = new PriorityQueue<>((o1, o2) -> o1 - o2);
    ...
    // 首先选择小头堆来解决问题
    public int getKMaxElement10(int[] arr, int k) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        Queue<Integer> queue = new PriorityQueue<>((o1, o2) -> o1 - o2);
    ...
    public int getKMaxElement11(int[] arr, int k) {
        // 通过小头堆解决问题
        if (arr == null || arr.length == 0) {
            return -1;
        }
    ...
    public int getKMaxElement12(int[] arr, int k) {
        if (arr == null || arr.length == 0) {
            return -1;
        }
        Queue<Integer> queue = new PriorityQueue<>((o1, o2) -> o1 - o2);
    ...
    public static void main(String[] args) {
        ...
        int kMaxElement = arrayKMaxElement.getKMaxElement12(arr, 2);

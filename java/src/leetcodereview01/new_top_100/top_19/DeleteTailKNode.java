...
public class DeleteTailKNode {
    ...
    public Node deleteTailKNode05(Node head, int k) {
        // 删除倒数K个节点
        if (head == null) {
            return null;
        }
    ...
    public Node deleteTailKNode07(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node pre = head;
    ...
    public Node deleteTailKNode09(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node deleteTailKNode10(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node deleteTailKNode11(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public Node deleteTailKNode12(Node head, int k) {
        if (head == null) {
            return null;
        }
        Node P1 = head;
    ...
    public static void main(String[] args){
        ...
        Node node = deleteTailKNode.deleteTailKNode12(node1, 5);
        while(node != null) {

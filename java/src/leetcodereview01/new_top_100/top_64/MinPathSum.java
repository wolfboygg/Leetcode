...
public class MinPathSum {
    ...
    public int findPath07(int[][] matrix) {
        if (matrix == null) {
            return -1;
        }
        int row = matrix.length;
    ...
    public int findPath08(int[][] matrix) {
        if (matrix == null) {
            return -1;
        }
        int row = matrix.length;
    ...
    public int findPath09(int[][] matrix) {
        int row = matrix.length;
        int column = matrix[0].length;
        int[][] dp = new int[row][column];
        for (int i = 0; i < row; i++) {
    ...
    public int findPath10(int[][] matrix) {
        if (matrix == null) {
            return -1;
        }
        int row = matrix.length;
    ...
    public static void main(String[] args) {
        ...
        int value = minPathSum.findPath10(matrix);

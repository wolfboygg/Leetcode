...
public class BinaryTreeCommonParent {
    ...
    public TreeNode findCommonParent05(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        if (root == node1 || root == node2) {
        ...
        TreeNode leftNode = findCommonParent05(root.left, node1, node2);
        TreeNode rightNode = findCommonParent05(root.right, node1, node2);
    ...
    // 二叉树的公共父亲节点
    public TreeNode findCommonParent06(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        if (node1 == root || node2 == root) {
        ...
        TreeNode leftNode = findCommonParent06(root.left, node1, node2);
        TreeNode rightNode = findCommonParent06(root.right, node1, node2);
        if (leftNode == null && rightNode == null) {
            return null;
        }
        if (leftNode != null && rightNode != null) {
    ...
    public TreeNode findCommonParent08(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        if (node1 == root || node2 == root) {
        ...
        TreeNode leftComm = findCommonParent08(root.left, node1, node2);
        TreeNode rightComm = findCommonParent08(root.right, node1, node2);
    ...
    public TreeNode findCommonParent11(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        if (root == node1 || root == node2) {
    ...
    public TreeNode findCommonParent12(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        if (root == node1 || root == node2) {
        ...
        TreeNode left = findCommonParent12(root.left, node1, node2);
        TreeNode right = findCommonParent12(root.right, node1, node2);
    ...
    public TreeNode findCommonParent13(TreeNode root, TreeNode node1, TreeNode node2) {
        if (root == null) {
            return null;
        }
        ...
        TreeNode left = findCommonParent13(root.left, node1, node2);
        TreeNode right = findCommonParent13(root.right, node1, node2);
        if (left == null && right == null) {
            return null;
        }
        if (left != null && right != null) {
    ...
    public static void main(String[] args) {
        ...
        TreeNode commonParent = binaryTreeCommonParent.findCommonParent13(node1, node4, node5);

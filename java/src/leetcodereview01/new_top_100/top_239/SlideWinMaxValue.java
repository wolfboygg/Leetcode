...
public class SlideWinMaxValue {
    ...
    public List<Integer> findWinMaxValue04(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return new ArrayList<>();
        }
        PriorityQueue<Integer> queue = new PriorityQueue<>((o1, o2) -> o2 - o1);
    ...
    // 滑动窗口求解问题
    public List<Integer> findWinMaxValue05(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        List<Integer> list = new ArrayList<>();
    ...
    public List<Integer> findWinMaxValue06(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        Queue<Integer> queue = new PriorityQueue<>(((o1, o2) -> o2 - o1));
    ...
    // 滑动窗口的最大值
    public List<Integer> findWinMaxValue07(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        List<Integer> list = new ArrayList<>();
    ...
    public List<Integer> findWinMaxValue09(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        Queue<Integer> queue = new PriorityQueue<>(((o1, o2) -> o2 - o1));
    ...
    public List<Integer> findWinMaxValue10(int[] arr, int win) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        Queue<Integer> queue = new PriorityQueue<>((o1, o2) -> o2 - o1);
    ...
    public static void main(String[] args){
        ...
        List<Integer> value = slideWinMaxValue.findWinMaxValue10(arr, 3);

...
//        Arrays.fill(dp, coin + 1);
    ...
    public int calculate10(int[] coins, int amount) {
        if (coins == null || coins.length == 0) {
            return -1;
        }
        int[] dp = new int[amount + 1];
    ...
    public int calculate11(int[] coins, int amount) {
        if (coins == null || coins.length == 0) {
            return -1;
        }
        int[] dp = new int[amount + 1];
    ...
    public int calculate12(int[] coins, int amount) {
        if (coins == null || coins.length == 0) {
            return -1;
        }
        int[] dp = new int[amount + 1];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(coinChange.calculate12(coins, amount));
    }
}

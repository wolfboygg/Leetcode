...
public class AllSequence {
    ...
    public List<List<Integer>> allSequence07(int[] arr) {
        if (arr == null) {
            return null;
        }
        boolean[] mark = new boolean[arr.length];
        backTracking07(arr, mark, new ArrayList<>());
        return ret;
    }

    public void backTracking07(int[] arr, boolean[] mark, List<Integer> list) {
        if (list.size() == arr.length) {
            ret.add(new ArrayList<>(list));
            return;
        }
    ...
    public List<List<Integer>> allSequence09(int[] arr) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        boolean[] mark = new boolean[arr.length];
        backTracking09(arr, mark, new ArrayList<>());
        return ret;
    }

    public void backTracking09(int[] arr, boolean[] mark, List<Integer> list) {
    ...
    public List<List<Integer>> allSequence10(int[] arr) {
        if (arr == null || arr.length == 0) {
            return null;
        }
        boolean[] mark = new boolean[arr.length];
        backTracking10(arr, mark, new ArrayList<>());
        return ret;
    }

    public void backTracking10(int[] arr, boolean[] mark, List<Integer> list) {
        if (arr.length == list.size()) {
            ret.add(new ArrayList<>(list));
            return;
        }
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> result= allSequence.allSequence10(arr);

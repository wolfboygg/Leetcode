...
public class MaxSquare {
    ...
    public int getMaxSquare11(char[][] matrix) {
        // 就一个最大的积
        if (matrix == null) {
            return -1;
        }
    ...
    public int getMaxSquare12(char[][] matrix) {
        if (matrix == null) {
            return -1;
        }
        int max = 0;
    ...
    public int getMaxSquare13(char[][] matrix) {
        if (matrix == null) {
            return -1;
        }
        int row = matrix.length;
    ...
    public static void main(String[] args) {
        ...
        int area = maxSquare.getMaxSquare13(matrix);

...
public class ReverseTree {
    ...
    public TreeNode reverseTree09(TreeNode root) {
        if (root == null) {
            return null;
        }
        TreeNode left = reverseTree09(root.left);
        TreeNode right = reverseTree09(root.right);
        root.left = right;
        root.right = left;
        return root;
    }
    ...
    public TreeNode reverseTree10(TreeNode root) {
        if (root == null) {
            return null;
        }
        TreeNode left = reverseTree10(root.left);
        TreeNode right = reverseTree10(root.right);
        root.left = right;
        root.right = left;
        return root;
    }

    public TreeNode reverseTree11(TreeNode root) {
        if (root == null) {
            return null;
        }
        TreeNode left = reverseTree11(root.left);
        TreeNode right = reverseTree11(root.right);
        root.left = right;
        root.right = left;
        return root;
    }

    public TreeNode reverseTree12(TreeNode root) {
        if (root == null) {
            return null;
        }
        TreeNode left = reverseTree11(root.left);
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        TreeNode node = reverseTree.reverseTree12(root0);

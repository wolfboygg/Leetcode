...
public class XJListNode {
    ...
    public Node findXJNode09(Node node1, Node node2) {
        if (node1 == null || node2 == null) {
            return null;
        }
        Node P1 = node1;
    ...
    public Node findXJNode10(Node node1, Node node2) {
        if (node1 == null || node2 == null) {
            return null;
        }
        Node P1 = node1;
    ...
    public Node findXJNode11(Node node1, Node node2) {
        Node P1 = node1;
        Node P2 = node2;
        while(P1 != P2) {
            P1 = P1 == null ? node2 : P1.next;
    ...
    public static void main(String[] args) {
        ...
        Node xjNode = xjListNode.findXJNode11(node1, node7);

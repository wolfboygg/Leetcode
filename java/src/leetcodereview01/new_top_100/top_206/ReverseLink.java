...
public class ReverseLink {
    ...
    public Node reverse06(Node head) {
        if (head == null) {
            return null;
        }
    ...
    public Node reverse07(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverse08(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverse09(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverse10(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public Node reverse11(Node head) {
        if (head == null) {
            return null;
        }
        Node pre = new Node(-1);
    ...
    public static void main(String[] args) {
        ...
        Node node = reverseLink.reverse11(node1);
        while(node != null) {
